...
public class Chapter implements Serializable {
    ...
    public static Chapter fillChapter(Scanner scanner) throws FiledIncorrect {
        ...
        Integer marinesCount = (Integer) ConsoleReader.conditionalRead(scanner, "Введите marinesCount (от 0 до 1000): ", false, Integer::parseInt, (m) -> Integer.parseInt(m) > 0, m -> Integer.parseInt(m) <= 1000);
