...
//        logger.addHandler(fileTxt);
        ...
        CommandManager manager = CommandManager.getInstance("s312619", "hiu404");
        ...
        manager.initCommand(SaveCommand.class, "save", "Сохраняет информацию в файл, использовать можно только на сервере");
    ...
    public String interpret(Request request, DatagramPacket da) throws ExecutionException, InterruptedException {
        System.out.println("2222");
        hasNewPacket = false;
        ExecutorService service = Executors.newCachedThreadPool();
        Future<Object> outPut = (Future<Object>) service.submit(() -> {
