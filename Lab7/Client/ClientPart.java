...
public class ClientPart {
    ...
    private String[] loginAndPasswordInput() {
        ...
        do {
            password = safeRead("Enter your password: (не допускаются пробельные символы)");
    ...
    public void understanding() {
        ...
        while (!command.equals("exit")) {
            command = safeRead("Enter the commands: (help for help)");
            try {
                understand(command);
    ...
    private void understand(String command) throws ConnectionException {
        ...
        } catch (NumberFormatException e) {System.out.println("The argument has a neutral type (для id - int, для price - double)");}
